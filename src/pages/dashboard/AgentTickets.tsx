...
const MOCK_ASSIGNED_TICKETS = [
    { id: '1', name: 'Elena Gilbert', message: 'My flower delivery seems to be stuck in...', time: '2m ago' },
    { id: '2', name: 'Elena Gilbert', message: 'My flower delivery seems to be stuck in...', time: '2m ago' }
];
    ...
    return (
        <div className="bg-white rounded-2xl p-6 border border-[#FFD2D6]/40 shadow-[0_4px_20px_rgba(86,0,12,0.03)] mt-6 flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-4">
                {MOCK_ASSIGNED_TICKETS.map((ticket, index) => (
                    <div 
                        key={index} 
